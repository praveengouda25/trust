...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "VISTARX Hostel360" },
      {
        name: "description",
        content: "Hostel, student and welfare operations software for NGO trusts.",
      },
      { name: "author", content: "VISTARX" },
      { property: "og:title", content: "VISTARX Hostel360" },
      {
