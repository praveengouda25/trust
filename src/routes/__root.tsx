...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "SVRST Trust — Education, Health & Food Support" },
      {
        name: "description",
        content:
          "SVRST Trust works with communities on education, healthcare, food support and women empowerment. Donate, volunteer or request help.",
      },
      { name: "author", content: "SVRST Trust" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
    ],
    links: [
      { rel: "stylesheet", href: appCss },
      { rel: "icon", href: "/assets/images/svrst-logo.png", type: "image/png" },
...
function RootComponent() {
  ...
  return (
    <QueryClientProvider client={queryClient}>
      ...
      <Navbar />
      <AnimatedBackground variant="ambient" className="fixed z-0 opacity-70" />
